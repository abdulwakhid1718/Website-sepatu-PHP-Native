            ...
            <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
              <div class="row mb-2">
                <div class="col-sm-12 col-md-6">
                  <a href="?p=suplier&a=tambah" class="btn btn-success mr-2"><i class="fa fa-plus-square mr-2"></i>Tambah Data</a>
                  ...
                  >
                    ...
                    <tbody>
                      <?php 
                        ...
                        while ($suplier = $data_suplier->fetch_assoc()):
                      ?>
                        <tr class="odd">
                        ...
                        <td>
                          <a href="?p=suplier&a=ubah&id=<?= $suplier['id_suplier']; ?>" type="button" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                          <a href="?p=suplier&a=hapus&id=<?= $suplier['id_suplier']; ?>" type="button" class="btn btn-danger btn-sm" id="confirmDelete"><i class="fa fa-trash"></i></a>
                        </td>
                      </tr>
                      <?php endwhile; ?>
                    </tbody>
